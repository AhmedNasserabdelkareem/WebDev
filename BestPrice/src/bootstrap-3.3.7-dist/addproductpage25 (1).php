...
$sql = "INSERT INTO comments (pname,supplier,price, tedata, user,id)
VALUES ('$productname', '$proplace','$proprice','$prodate','ahmed','$k')";
$proplace='';
...
$sql = "SELECT pname, supplier, price, tedata, user FROM comments where id=".$k;
$result = $conn->query($sql);
$i=1;

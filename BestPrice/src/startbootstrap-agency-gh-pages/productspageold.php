      ...
      if (empty($row["filename"]))
        continue;
            ...
            <span class="glyphicon glyphicon-hand-up" aria-hidden="true"></span> view
                        ...
                        <img src= "img/'. $row["filename"].'" class="img-responsive" alt="">
                    </a>
...
function myFunction28() {
 ...
 <div class="portfolio-hover-content">
      ...
      <div  hidden class=" add2 portfolio-hover-content">
                              <button  type="button" id= "btn3" class=" add2 btn btn-default btn-lg">   <span class="glyphicon glyphicon-hand-up" aria-hidden="true"></span> add new product</button>
                            </div>
         <div  hidden class=" add3 portfolio-hover-content">
                              <button  type="button" id= "btn4" class=" add3 btn btn-default btn-lg">   <span class="glyphicon glyphicon-hand-up" aria-hidden="true"></span> add new product</button>
                            </div></section>

                        ...
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                              <form method ="post" action ="../bootstrap-3.3.7-dist/addproductpage25.php">
                                 <button  id="myButton1" type="submit" class="btn btn-default btn-lg" name='.$i.'>
...
<script type="text/javascript">
    document.getElementById("myButton1").onclick = function () {
        location.href = "file:///C:/xampp/htdocs/kakhled/startbootstrap-agency-gh-pages/mainpage.php";
    };
</script>
                ' ;
                 }
